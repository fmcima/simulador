...
export default function CapexMain({ currentParams, onUpdate, peakProduction }) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    <div className="relative z-10">
                        ...
                        <h3 className="text-lg font-bold text-slate-600 dark:text-slate-300 mb-2">Poços & Sondagem</h3>
            ...
            {activeModule !== 'selection' && (
                <div className="flex items-center gap-2 mb-6 text-sm">
                    ...
                    <span className="font-semibold text-blue-600 dark:text-blue-400">
                        {activeModule === 'fpso' ? 'FPSO' : activeModule}
                    </span>
                </div>
            )}
